<template>
  <q-item>
    ...
    <q-item-section side bottom>
      <q-item-label caption>{{ $moment(entity.published_at).fromNow() }} <q-icon name="lens" :color="entity.active ? (entity.published ? 'positive' : 'warning') : 'negative'" /> <q-icon name="info">
        <q-popup-proxy>
          <q-card>
            <q-card-section class="text-caption">
              ...
              From: <strong>{{ entity.published_at }}</strong><br>
              To: <strong>{{ entity.unpublished_at }}</strong><br>
